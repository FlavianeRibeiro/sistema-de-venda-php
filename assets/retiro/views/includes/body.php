...
<head>
    ...
    <title>Retiro jovem vem e segue-me</title>
...
<body>
    ...
    <!-- Mainly scripts -->
    <script src="../boostrap/js/jquery-2.1.1.js"></script>
    <script src="../boostrap/js/bootstrap.min.js"></script>
    <script src="../boostrap/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="../boostrap/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="./s/plugins/jquery-ui/jquery-ui.min.js"></script>
